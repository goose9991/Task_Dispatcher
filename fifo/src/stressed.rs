...
fn main() {
    ...
    println!("=======================================================");
    println!("  Simulation A – FIFO  |  Experiment B: Stressed (Burst Arrivals)");
    println!("=======================================================");
    ...
    // Generator — burst pattern: send `burst_size` tasks every `arrival_interval_ms`
    {
        ...
        while sent < cfg.num_tasks {
            ...
            for _ in 0..burst {
                ...
                let mut task = Task::new((sent + 1) as u32, kind, cpu_cost,
    ...
    println!("\n╔══════════════════════════════════════════════════════╗");
    println!("║  FIFO Results — Experiment B (Stressed/Burst)        ║");
    println!("╚══════════════════════════════════════════════════════╝");
    println!("\n  ── Required Metrics ──────────────────────────────────");
